...
#    Updated: 2020/03/17 18:01:29 by mli              ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_FILES = ft_printf.c ftpf_argsfill.c ftpf_diux.c ftpf_csp.c ftpf_write.c \
...
all:
	@echo "\033[1mMake ft_printf\033[0m"
	@make ${NAME}
...
clean:
	@echo "\033[1m\x1b[33mRemove ft_printf... |\x1b[32m| done\x1b[0m"
	@rm -rf ${OBJS}

fclean: clean
	@echo "\033[1m\x1b[33mRemove all ft_printf|\x1b[32m| done\x1b[0m"
	@rm -rf ${NAME}
